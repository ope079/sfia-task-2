...
d1 = pd.read_csv('/home/o_ore/sfia-task-2/backend1/tests/csv/FB1.csv', header=0)
value = pd.read_csv('/home/o_ore/sfia-task-2/backend1/application/csv/.csv', header=0)
